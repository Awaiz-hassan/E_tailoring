...
public class SingleCheckoutOne extends Fragment {
    ...
    Button proceed;
    String title,price,quantity,id;
    public SingleCheckoutOne() {
        // Required empty public constructor
    }

    public static SingleCheckoutOne newInstance(String price,String Title,String Quantity,String id) {
        SingleCheckoutOne fragment = new SingleCheckoutOne();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_single_checkout_one, container, false);
            ...
            public void onClick(View view) {
                if(addressAdapter!=null){
                    if(addressAdapter.getItemSelected()!=-1){
                        Fragment myFragment = SingleCheckoutTwo.newInstance(title,quantity,price,addressList.get(addressAdapter.getItemSelected()).getAddress(),id);
